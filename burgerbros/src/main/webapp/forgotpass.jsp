...
<body>
  <div>
  <form class="modal-content" action="forgotpassaction.jsp" onsubmit="return validate()">
    <div class="container">
      ...
      <div class="clearfix">
        <button type="button" class="cancelbtn"><a href="http://localhost:8081/burgerbros/homepage.jsp">Cancel</a></button>
