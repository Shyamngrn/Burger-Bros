...
<ul class="topnav">
  ...
  <li ><a href="displaycateringdetails.jsp">Catering Orders</a></li>
    <li ><a class="active"href="displayreservationdetails.jsp">Reservations</a></li>
...
<td><%=resultSet.getString("rtime") %></td>
...
%>
<h1>TABLE FOR FOUR:-</h1>
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select * from fourreservations";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr>
